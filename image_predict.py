...
def main(args):
    ...
    model.to(device)
    json_path = '/home/bill/Documents/AI_Microwave_Oven/Conformer-main/class_indices.json'
    ...
    f = open('/home/bill/Documents/AI_Microwave_Oven/result.txt', mode='w', encoding='utf-8')
...
def item_cls():
    if __name__ == '__main__':
        def get_args_parser():
            ...
            parser.add_argument('--image_path', default='/home/bill/Documents/AI_Microwave_Oven/app/static/images', type=str)
            parser.add_argument('--device', default='cuda:0')
            parser.add_argument('--input_size', type=int, default=448)
            parser.add_argument('--model', default='Conformer_small_patch16', type=str, metavar='MODEL',
                                help='Name of model to train')
            parser.add_argument('--nb_classes', type=int, default=17)
            ...
            parser.add_argument('--weights', type=str,
                                default='/home/bill/Documents/AI_Microwave_Oven/Conformer-main/MergePET/model-299-94.10150888492704.pth')
            return parser
